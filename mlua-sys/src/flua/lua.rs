...
unsafe extern "C-unwind" {
    ...
    #[link_name = "lua_getlfield"]
    pub fn lua_getlfield_(L: *mut lua_State, idx: c_int, k: *const c_char, l: usize);
    ...
    #[link_name = "lua_rawgetglobal"]
    pub fn lua_rawgetglobal_(L: *mut lua_State, name: *const c_char);
    ...
    #[link_name = "lua_setlfield"]
    pub fn lua_setlfield_(L: *mut lua_State, idx: c_int, k: *const c_char, l: usize);
    ...
    pub fn lua_rawsetglobal(L: *mut lua_State, name: *const c_char);
